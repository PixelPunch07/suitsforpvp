...
function ENT:Use(activator, caller)
 if (!caller.isWearingArmor) then
	...
	caller:SetMaterial("freak_fortress_2/nrc_v4/jul13_shoguns_guard_blue")
	caller:SetWalkSpeed( 200 )
	caller:SetHealth( 25000000 )
	caller:SetMaxHealth( 25000000 )
	caller:Give("weapon_suit_fists")
	caller:SetBloodColor( 3 )
	caller:SetModel("models/delta/destiny2/TitanExileMale.mdl")
