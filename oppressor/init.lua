...
function ENT:Use(activator, caller)
 if (!caller.isWearingArmor) then
	...
	caller:SetRunSpeed( 1200 )
	caller:SetWalkSpeed( 200 )
	caller:SetHealth( 800000 )
	caller:SetArmor ( 600000 )
	caller:SetMaxHealth( 800000 )
	caller:Give("weapon_suit_fists")
	caller:SetBloodColor( 3 )
	caller:SetModel("models/SDWAN/Arkham_Knight/playermodels/Arkham_Knight.mdl")
