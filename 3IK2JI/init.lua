...
function ENT:Use(activator, caller)
 if (!caller.isWearingArmor) then
	...
	caller:EmitSound("weapons/gblaster/ambienceofgoditself.mp3")
	caller:SetRunSpeed( 10000 )
	caller:SetWalkSpeed( 200 )
	caller:SetHealth( 999999999 )
	caller:SetMaterial("z_easyskins/camo/corrupt")
	caller:SetMaxHealth( 999999999 )
	caller:Give("experimentgonewrong")
	caller:SetBloodColor( 3 )
	caller:SetModel("models/player/skeleton.mdl")
